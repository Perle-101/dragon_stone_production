...
<head>
   ...
   <title>Bathroom & Personal Care</title>
...
<div class="banner">
   <div class="start-nav">
      ...
      <p>Discover the best Bathroom & Personal Care for you</p>
   </div>
</div>
...
<section class="products" >
   <div class="head-container">
      <h1 class="heading">Bathroom & Personal Care</h1>
      <h3>
   ...
   <div class="box-container">
      ...
      $select_products = mysqli_query($conn, "SELECT * FROM `products` WHERE category = 'Bathroom & Personal Care'");
